...
public class MainActivity extends AppCompatActivity {
    ...
    private void createAppCar() {
        ...
        if (TextUtils.isEmpty(placa)){
            editTextPlaca.setError("Digite a placa do carro");
            editTextPlaca.requestFocus();
            return;
        }
        if (TextUtils.isEmpty(servico)){
            editTextServico.setError("Digite o serviço a ser efetuado");
        ...
        PerformNetworkRequest request = new PerformNetworkRequest(Api.URL_CREATE_APP, params, CODE_GET_REQUEST);
        request.execute();
    ...
    private void updateAppCar(){
        ...
        String carro = editTextCarro.getText().toString();
        String placa = editTextPlaca.getText().toString();
        String servico = editTextServico.getText().toString();
        ...
        if (TextUtils.isEmpty(servico)){
            editTextPlaca.setError("Digite o serviço a ser efetuado");
            editTextPlaca.requestFocus();
            return;
        }
    ...
    private void refresAppCarList(JSONArray appcar) throws  JSONException{
        appcarList.clear();
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!object.getBoolean("error")) {
                    ...
                    refresAppCarList(object.getJSONArray("appcar"));
                }
            ...
            public  View getView(int position, View convertView, ViewGroup parent){
                ...
                textViewDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setTitle("Delete" + appCar.getCarro()).setMessage("Você quer mesmo deletar?").setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                    @Override
