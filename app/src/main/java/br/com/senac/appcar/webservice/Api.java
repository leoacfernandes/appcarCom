...
public class Api {
    private static final String ROOT_URL = "https://leonardoaugustocaetanofernandes.000webhostapp.com/appcarapi/v1/Api.php?apicall=";
    public static final String URL_CREATE_APP = ROOT_URL + "createappcar";
